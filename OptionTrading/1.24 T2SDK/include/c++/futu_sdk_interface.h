...
struct IFuCallBack:public IHSKnown
{
	...
	*/
	...
	//20130527 chends  交易所状态支持快照查询 修改单：20130402041
	/**
	 * 交易所状态反馈信息
	 *@param lpComm     通信接口对象,以区分多连接的应用
	 *@param lpInfo     交易所状态反馈信息(参见CExchStatusInfo结构的定义)
	 *@param rAction    表示是快照还是订阅主推
	*/
	virtual void HSAPI OnRecvExchStatsInfo(IHsFutuComm* lpComm,const CExchStatusInfo* lpInfo,REGAction rAction) = 0;
